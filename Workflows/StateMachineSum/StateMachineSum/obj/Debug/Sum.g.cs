...
namespace StateMachineSum {
    ...
    public partial class Sum : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
        
        private bool _contentLoaded;
        
        private System.Activities.OutArgument<int> _inputNumber;
        
        private System.Activities.InArgument<string> _argument1;
        
        private System.Activities.InArgument<string> _argument2;
...
partial void AfterInitializeComponent();
        ...
        public System.Activities.OutArgument<int> inputNumber {
            get {
        ...
        public System.Activities.InArgument<string> argument2 {
            get {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(Sum).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(Sum));
        ...
        private string FindResource() {
            string[] resources = typeof(Sum).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".Sum.g.xaml") || resource.Equals("Sum.g.xaml"))) {
                    return resource;
                }
            }
