...
namespace StateMachineSumSample {
    ...
    public partial class SumOfNumbers : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(SumOfNumbers).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(SumOfNumbers));
        ...
        private string FindResource() {
            string[] resources = typeof(SumOfNumbers).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".SumOfNumbers.g.xaml") || resource.Equals("SumOfNumbers.g.xaml"))) {
                    return resource;
                }
            }
